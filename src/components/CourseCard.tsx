...
export function CourseCard({
  ...
  const heightClass =
    cardHeight || 'h-[400px] sm:h-[450px] md:h-[500px] lg:h-[540px]';
  return (
    <Link
      href={href}
      prefetch={false}
    ...
    >
      <div
        className={`relative ${heightClass} bg-gradient-to-bl from-card via-card to-card/80 rounded-xl sm:rounded-2xl overflow-hidden shadow-lg transition-all duration-500 ease-out hover:shadow-2xl hover:shadow-primary/10 hover:translate-y-[-8px] border border-border/50 hover:border-primary/20 group-hover:bg-gradient-to-bl group-hover:from-card group-hover:via-card/95 group-hover:to-primary/5`}
      >
        ...
        <div className='p-4 sm:p-6 flex flex-col flex-1 relative'>
          ...
          {showProgressFirst ? (
            <>
              ...
              {course.instructor && (
                <div
                  className='relative flex items-center justify-between mb-3 sm:mb-4 p-2 sm:p-3 rounded-xl border border-border/50 overflow-hidden group-hover:border-primary/20 transition-all duration-300'
                  style={{
                    background:
